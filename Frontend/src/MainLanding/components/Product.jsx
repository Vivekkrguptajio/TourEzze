...
export default function Product() {
  return (
    <section className="relative py-24 bg-gradient-to-b from-orange-50 via-amber-50 to-white overflow-hidden">
      ...
      {/* Stronger Decorative Background Orbs */}
      <div className="absolute top-[-50px] right-[-50px] w-[450px] h-[450px] bg-orange-300/40 rounded-full blur-[120px]"></div>
      <div className="absolute bottom-[-80px] left-[-80px] w-[550px] h-[550px] bg-green-300/35 rounded-full blur-[140px]"></div>

      <div className="relative max-w-7xl mx-auto px-6">
        
        {/* Header */}
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-orange-200 to-amber-200 rounded-full mb-4 border border-orange-300/60">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-green-700 via-orange-600 to-green-700 bg-clip-text text-transparent">
