...
export default function GuideSidebar() {
  ...
  return (
    <aside className="w-64 bg-green-700 text-white h-screen fixed left-0 top-0 flex flex-col justify-between">

      {/* TOP MENU (scrollable) */}
      <div className="pt-6 px-4 overflow-y-auto">
      ...
      <div className="p-4 border-t border-green-800">
        <Link
          to="/role/guide/logout"
          className="flex items-center gap-2 px-3 py-2 rounded-lg cursor-pointer hover:bg-red-600 transition text-sm bg-red-500"
        >
          <LogOut size={18} />
